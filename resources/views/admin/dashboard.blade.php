                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @if ($attendance->photo_path)
                                            <img src="{{ asset('storage/' . $attendance->photo_path) }}" alt="Photo" class="h-20 w-50 object-cover rounded-full">
                                        @else
                                    ...
                                    <td id="kehadiran-{{ $attendance->id }}" class="px-6 py-4 whitespace-nowrap text-white text-sm">{{ $attendance->kehadiran }}</td>
                                    
                                    <td class="px-6 py-4 whitespace-nowrap">  <form action="{{ route('attendance.destroy', $attendance->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus absen ini?');">
                                        @csrf
                                        @method('DELETE')
